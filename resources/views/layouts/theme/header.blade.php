    ...
    <header class="header navbar navbar-expand-sm">
        <ul class="navbar-item flex-row">
            <li class="nav-item theme-logo">
                <a href="index.html" style="display: flex; flex-direction: column; align-items: center; text-align: center;">
                    <img src="assets/img/supermercado.jpg" class="navbar-logo" alt="logo">
                    <p style="font-size: 12px; color:#3B3F5C; text-align: center;">Supermercado 'Q mas pues'</p>
                </a>
            </li>
        </ul>
