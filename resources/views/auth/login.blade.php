                        ...
                        <form method="POST" action="{{ route('login') }}" class="text-left">
                            ...
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="email" name="email" type="email" class="form-control" placeholder="Por ejemplo, john.doe@example.com" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                </div>
                                ...
                                <p class="signup-link">¿No tienes una cuenta? <a href="{{ route('register') }}">Regístrate</a></p>
                            </div>
                        </form>
                    </div>                    
                </div>
